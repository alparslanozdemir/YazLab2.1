...
<head>
    ...
    <title>Kelime Frekans Bulucu</title>
</head>
<body>
<form action="" method="post">
    ...
    <input type="submit" name="gonder" value="Kelime Frekanslarını Listele">
</form>
</body>
</html>
...
if(isset($_POST["url"]))
{
    ...
    arsort($kelimedizisi);
    print_r($kelimedizisi);

}
function ayikla($url)
{
    // Tüm sayfa kaynak kodunu çeker.
    ...
    $metin = preg_replace("/\b[a-zA-Z]{1,3}\b/i",'',$metin);
...
function temizle($text) // İçerisinde harf harici karakter olan kelimeler yok edilir.
{
    $result = preg_replace(
        '/\b            # Start of word
